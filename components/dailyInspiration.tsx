          ...
          {leftCards.map((inspiration) => (
            ...
            >
              ...
              <div className="flex items-center justify-between mt-3">
                ...
                <div className="h-px flex-1 bg-black mx-2"></div>
        ...
        {rightCard && (
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-2 mb-2">
              <a
                href="/lifestyle"
                className="hover:underline text-[12px] bg-[#ffbd3a4b] px-2 py-[1px] font-medium"
              >
                Lifestyle
              </a>
              ...
              <p className="text-[12px] text-gray-800 whitespace-nowrap">
