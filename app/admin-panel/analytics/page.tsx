...
export default function AnalyticsPage() {
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6">
      <button className="text-lg sm:text-xl font-semibold px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">
        Analytics Overview
      </button>
      ...
      <div className="mt-6 bg-[#FFFDFA] p-4 border rounded shadow-sm">
        <h3 className="text-base sm:text-lg font-semibold mb-4">Blogs vs Users</h3>
